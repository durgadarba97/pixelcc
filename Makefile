...
SOURCE_FILES = src/wave.cc src/conway.cc src/lorenz.cc src/boids.cc
...
TEST_SOURCES = tests/testwave.cc tests/testconway.cc tests/testlorenz.cc tests/testboids.cc
...
spotify: src/spotify.o tests/testspotify.o $(RGB_LIBRARY)
	$(CXX) $(CXXFLAGS) -I$(RGB_INCDIR) $(TEST_OBJECTS2) $(SOURCE_OBJECTS) -o $@ $(LDFLAGS) $(LDLIBS)

src/spotify.o: src/spotify.cc
	$(CXX) $(CXXFLAGS) -c -o $@ $<

boids : $(TEST_OBJECTS2) $(SOURCE_OBJECTS) $(RGB_LIBRARY)
